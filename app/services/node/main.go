...
func run(log *zap.SugaredLogger) error {
	...
	fmt.Println(`       __ _  ___      ____  _     ___   ____ _  ______ _   _    _    ___ _   _  `)
	fmt.Println(`     /  _  |/ _ \    | __ )| |   / _ \ / ___| |/ / ___| | | |  / \  |_ _| \ | | `)
	fmt.Println(`     | |_)_| | | |   |  _ \| |  | | | | |   | ' / |   | |_| | / _ \  | ||  \| | `)
	fmt.Println(`     | \,  | |_| |   | |_) | |__| |_| | |___| . \ |___|  _  |/ ___ \ | || |\  | `)
	fmt.Println(`      \___/ \___/    |____/|_____\___/ \____|_|\_\____|_| |_/_/   \_\___|_| \_| `)
	fmt.Print("\n")
